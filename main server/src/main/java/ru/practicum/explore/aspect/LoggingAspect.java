package ru.practicum.explore.aspect;
...
public class LoggingAspect {
    ...
    @Before("execution(* ru.practicum.explore.*.controller.*.*(..))")
    ...
    @After("execution(* ru.practicum.explore.*.controller.*.*(..))")
    ...
    @AfterThrowing(value = "execution(* ru.practicum.explore.*.*.*.*(..))", throwing = "ex")
