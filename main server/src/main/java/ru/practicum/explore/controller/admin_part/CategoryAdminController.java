...
public class CategoryAdminController {
    ...
    @PatchMapping
    public CategoryFullDto updateCategory(@Valid @RequestBody CategoryFullDto categoryFullDto) {
    ...
    @DeleteMapping("{catId}")
    void removeCategory(@Positive @PathVariable Long catId) throws AccessDeniedException {
